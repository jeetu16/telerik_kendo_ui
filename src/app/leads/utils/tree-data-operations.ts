...
export const processTreeData = (data: Array<object>, state: { expanded: Array<number>, value: string | undefined, filter: any }, fields: { selectField: string, expandField: string, dataItemKey: string, subItemsField: string }) => {
